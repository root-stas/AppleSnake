...
public class UDTEventHandler : MonoBehaviour, IUserDefinedTargetEventHandler
{
    ...
    public void OnFrameQualityChanged(ImageTargetBuilder.FrameQuality frameQuality)
    {
        ...
        if (mFrameQuality == ImageTargetBuilder.FrameQuality.FRAME_QUALITY_LOW)
        {
            ...
            if (LogTxT != null) LogTxT.text = "Low camera image quality";
        }
    }
    ...
    public void OnNewTrackableSource(TrackableSource trackableSource)
    {
        ...
        if (mBuiltDataSet.HasReachedTrackableLimit() || mBuiltDataSet.GetTrackables().Count() >= MAX_TARGETS)
        {
            ...
            if (oldest != null)
            {
                ...
                mBuiltDataSet.Destroy(oldest, false);
            }
        }

        // Get predefined trackable and instantiate it
        ImageTargetBehaviour imageTargetCopy = ImageTargetTemplate;// (ImageTargetBehaviour)Instantiate(ImageTargetTemplate);
        ...
        if (LogTxT != null) LogTxT.text = "Target is ready!";
    }
    ...
    public void BuildNewTarget()
    {
            ...
            mFrameQuality == ImageTargetBuilder.FrameQuality.FRAME_QUALITY_HIGH)
        {
            ...
            string targetName = string.Format("{0}-{1}", "ImageTarget", mTargetCounter);
        ...
        else
        {
            ...
            if (LogTxT != null) LogTxT.text = "Cannot build new target, due to poor camera image quality";
        }
    }
